 ...
 *
 * Transcribed from the Smooth Transitions PM Checklist. Sections and items are
 * the source document's; due dates are not. Each item names an `anchor` — a
 * milestone the move plan builder computes (see ScheduleResult.suggestedDates) —
 * plus an offset from it, so the checklist re-dates itself whenever the plan is
 * regenerated.
 *
 * anchor            resolves to
 * ────────────────  ────────────────────────────────────────────────────────────
...
export const DEFAULT_CHECKLIST_TEMPLATE: ChecklistTemplateSection[] = [
  {
    ...
    order: 1,
    description: 'Director of Business Operations & Director of Operations',
    items: [
      { id: 'ho-1', text: 'Director of Business Development hand off to Director of Operations', anchor: 'first-visit', offsetDays: -5, offsetMode: 'workday', owner: 'Dir. Bus. Dev' },
      { id: 'ho-2', text: 'Director of Operations calls client, creates move plan, and assigns a Project Manager', anchor: 'first-visit', offsetDays: -5, offsetMode: 'workday', owner: 'Dir. Ops' },
      { id: 'ho-3', text: 'Director of Operations emails client and Project Manager the move plan and introduction to the Project Manager', anchor: 'first-visit', offsetDays: -4, offsetMode: 'workday', owner: 'Dir. Ops' },
    ],
  },
  {
    id: 'sec-assignment',
  ...
  {
    id: 'sec-firstvisit',
    name: 'First Visit & Floor Plan Reveal',
    order: 3,
    ...
    items: [
      ...
      { id: 'fv-3', text: "Ask for a copy of the community floor plan if you don't already have one", anchor: 'first-visit', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
      { id: 'fv-4', text: 'Explain our colored masking tape system', anchor: 'first-visit', offsetDays: 0, offsetMode: 'calendar', owner: 'PM', note: 'RED — stays in home for dispersal. GREEN — goes to new home. BLUE — goes to family. ORANGE — donation. YELLOW — other designations (2nd stop, storage, etc.). Do not put tape directly on gold leaf, paintings, or delicate finishes.' },
      ...
      { id: 'fv-12', text: 'Get email / contact information', anchor: 'first-visit', offsetDays: 0, offsetMode: 'calendar', owner: 'Community' },
      ...
      // ── After the visit ──
      { id: 'fv-22', text: 'Send a follow-up email thanking them for their time and confirming the move date', anchor: 'first-visit', offsetDays: 1, offsetMode: 'workday', owner: 'PM' },
      { id: 'fv-23', text: 'If the client is moving OUT of a senior community, email the sales or move coordinator about the move out day and clean out day', anchor: 'first-visit', offsetDays: 1, offsetMode: 'workday', owner: 'PM' },
      ...
      // ── Reveal ──
      { id: 'fv-28', text: 'Floor plan reveal — tap laptop to show the 2D layout. Make adjustments if the client needs changes', anchor: 'second-visit', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
      { id: 'fv-29', text: 'Upload final image of floor plan as a JPEG or PDF to STWare (page 2 of the Sweet Home 3D file)', anchor: 'second-visit', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'sp-12', text: 'Confirm whether there is a shed, crawl space, or attic that needs to be addressed', anchor: 'sort-start', offsetDays: 1, offsetMode: 'workday', owner: 'PM' },
      { id: 'sp-13', text: 'Review contract for document sorting. If the client is sorting, make boxes for them to separate shredding', anchor: 'sort-start', offsetDays: 1, offsetMode: 'workday', owner: 'PM', note: "Suggest they keep: 3 years of tax returns or their accountant's recommendation; investment documents; identification documents; titles; 1 year of medical documents." },
  ...
  },
  {
    ...
    items: [
      { id: 'ld-1', text: 'Send the inbound (destination) SMM the box count, furniture inventory, floor plan, and move contact information', anchor: 'final-pack', offsetDays: -1, offsetMode: 'workday', owner: 'PM' },
  ...
  },
  {
    ...
    order: 6,
    items: [
      { id: 'fp-1', text: 'Send estimated box count to movers', anchor: 'final-pack', offsetDays: -1, offsetMode: 'workday', owner: 'Movers' },
      { id: 'fp-2', text: "Discuss the mover's optional protection per truckload", anchor: 'final-pack', offsetDays: -1, offsetMode: 'workday', owner: 'Movers' },
  ...
  },
  {
    ...
    order: 7,
    items: [
      { id: 'md-1', text: 'Project Manager purchases client gift; bring trash bags and floor plan copies', anchor: 'move-day', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
      ...
      { id: 'md-23', text: 'Double check: moving truck is empty', anchor: 'move-day', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
      { id: 'md-24', text: 'Double check: bookcases have shelves properly installed', anchor: 'move-day', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
      { id: 'md-25', text: 'Double check: note any damage to furniture', anchor: 'move-day', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
      { id: 'md-26', text: 'Double check: mechanical items work — bed frames, lift chairs, Sleep Number beds', anchor: 'move-day', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
      { id: 'md-27', text: 'Double check: headboard and footboard are tightened', anchor: 'move-day', offsetDays: 0, offsetMode: 'calendar', owner: 'PM' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'co-2', text: 'Sift rooms one at a time in teams of two while creating an inventory of items that will be sold, using Sortly', anchor: 'cleanout-start', offsetDays: 0, offsetMode: 'calendar', owner: 'Specialist' },
      ...
      { id: 'co-8', text: 'Notify the Director of Operations when Sortly is complete', anchor: 'cleanout-end', offsetDays: 1, offsetMode: 'workday', owner: 'Dir. Ops' },
    ],
  },
];
