...
export const DEFAULT_LISTS: ListCategory[] = [
  ...
  { id: 'crm-contact-type',    name: 'CRM Contact Type',    items: ['Community', 'Community Sales', 'Community Main', 'Community ED', 'Sales Coordinator', 'Move-In Coordinator', 'Facilities Manager', 'Mover', 'Disposal/Removal', 'Specialized Services'] },
