...
export function SelectField({
  ...
  return (
    <select
      ...
      disabled={disabled}
      className={`w-full min-h-[44px] rounded-xl border border-ios-gray-300 bg-white px-3 py-2 text-base text-gray-900 appearance-none focus:outline-none focus:ring-2 focus:ring-indigo-500 ${className}`}
