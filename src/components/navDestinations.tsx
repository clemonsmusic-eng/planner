 ...
 *
 * The phone bar, the phone menu and the desktop sidebar all render the same
 * three lists. Keeping the icons and labels here is what stops a tab added to
 * one from going missing on the other.
 */
...
/** The working tabs for an open project. */
export const PROJECT_TABS: Destination[] = [
...
/** The document pages for an open project, in the order they're used on a job. */
export const DOC_DESTINATIONS: Destination[] = [
  {
    tab: 'furniture',
...
/** Destinations that aren't tied to a project. */
...
/** Tabs reached through the documents menu, for highlighting its handle. */
export const DOC_TABS = new Set<TabName>(DOC_DESTINATIONS.map((d) => d.tab));
