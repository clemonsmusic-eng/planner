        ...
        <div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            */}
            ...
            />
            {/* The contact book, which outlives any one job. */}
            {can(level, 'crm') && <HomeButton
              label="CRM"
              colorClass="bg-teal-100 text-teal-700"
              onClick={() => dispatch({ type: 'SET_ACTIVE_TAB', tab: 'crm' })}
              icon={
            ...
            />}
            {/* Stock control across every job, not one project's work. */}
            {can(level, 'supplies') && <HomeButton
