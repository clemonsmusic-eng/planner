...
export const ENEMIES: Record<string, EnemyDef> = {
  ...
  stone_colossus: {
    ...
    description: 'Maestra Euphonia, your euphonium professor, sunk into one immovable low tone — a foundation holding up nothing, refusing to move.',
    power: 26,
    maxHp: 440,
  ...
  forest_flogger: {
    ...
    isBoss: true,
    phase2Threshold: 0.5,
    lore: 'His sister has crossed a desert and a mountain to reach him. Quiet the calls, and the fog will lift.',
  },
  double_reed_specter: {
