...
export const ZONE9_CONFIG: AssaultConfig = {
  ...
  skirmish: { enemyKey: 'wave_walker', doneKey: 'z9_wave_walker', icon: '🌊', name: 'Wave Walker', desc: 'A translucent sound-wave thing that slips along the corrupted shore.' },
  bosses: [
    { enemyKey: 'coastal_dissonance', doneKey: 'z9_coast_cleared', icon: '🌊', name: 'The Coastal Dissonance', desc: 'A standing swell of clashing frequencies guarding the water. Break it to board the ship.' },
  ],
...
export const ZONE10_CONFIG: AssaultConfig = {
  ...
  skirmish: { enemyKey: 'rogue_wave', doneKey: 'z10_rogue_wave', icon: '🌀', name: 'Rogue Wave', desc: 'An off-beat swell that rears up out of the dark and crashes against your rhythm.' },
  bosses: [
    { enemyKey: 'the_maelstrom', doneKey: 'z10_maelstrom', icon: '🌀', name: 'The Maelstrom', desc: 'A vast whirlpool that grows louder and wider every turn. Break it fast — or it breaks the ship.' },
  ],
...
export const ZONE11_CONFIG: AssaultConfig = {
  ...
  skirmish: { enemyKey: 'cacophony_soldier', doneKey: 'z11_guard', icon: '⚔️', name: 'Cacophony Soldier', desc: 'A made soldier of the Discordian Guard — far stronger when its fellows fight beside it.' },
  bosses: [
    { enemyKey: 'piano_commander', doneKey: 'z11_piano', icon: '🤫', name: 'Piano', desc: 'The soft knight-commander — strikes from near-silence, where you never hear the blade.' },
    { enemyKey: 'forte_commander', doneKey: 'z11_forte', icon: '💥', name: 'Forte', desc: 'The loud knight-commander — overwhelming, ground-splitting force. Both must fall.' },
  ],
